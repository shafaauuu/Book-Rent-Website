        ...
        <div className="py-36 flex flex-col items-center justify-center gap-8">
          ...
          <div className=" px-4 space-y-7">
            <h2 className="md:text-5xl text-4xl font-bold md:leading-snug leading-snug">
              Check All Of Your <span className="text-blue">incomplete transactions </span>
            </h2>
          </div>
          {/* table for the cart */}
  ...
  {transaction.map((item, index) => 
    ...
    item.status === "Unpaid" && (
      <tr key={index}>
        ...
        <th>
          <button className="btn btn-ghost btn-xs" onClick={handleConfirm}>Confirm Return</button>
        </th>
      </tr>
    )
  )}
